...
const TermsPage = () => {
  return (
    <div className="bg-brand-dark min-h-screen pt-40 pb-20">
      <div className="container-max">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-16 text-white">
            Operational <br /> Terms.
          </h1>
          
          <div className="prose prose-invert max-w-none space-y-12 text-[#FFFFFF]/60 font-medium leading-relaxed">
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">01 // Digital Contracts</h2>
              <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">02 // Intellectual Property</h2>
              <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">03 // Service Delivery</h2>
              <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">04 // Dispute Management</h2>
              <p>
