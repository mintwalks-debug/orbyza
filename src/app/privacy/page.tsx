        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none space-y-12 text-[#FFFFFF]/60 font-medium leading-relaxed">
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">01 // Data Intelligence</h2>
              <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">02 // Encryption & Security</h2>
              <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">03 // Third-Party Integration</h2>
              <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-black text-[#FFFFFF] uppercase tracking-widest border-b border-[#0047FF]/20 pb-4">04 // Contact HQ</h2>
              <p>
